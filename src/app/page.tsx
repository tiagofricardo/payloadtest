...
const perks = [
  ...
  },
  {
    ...
    icon: CheckCircle,
    description:
      "Every asset on our platform is ferified by our teaa to ensure our highest quality standards. Not happy? we offer a 30-day refund guarantee period.",
  },
  {
    name: "For the Planet",
    icon: Leaf,
    description:
      "We've pledged 1% of sales to the preservation and restoriation of the natural environment",
  },
];
