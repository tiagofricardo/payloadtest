...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl">
          <div className="lg:col-start-2">
            ...
            <div className="space-y-6 border-t boder-gray-200 pt-6 text-sm font-medium text-muted-foreground">
